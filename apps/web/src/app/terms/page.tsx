...
export const metadata = {
  title: "Terms of Service — Zor",
  description: "Terms governing your use of the Zor fitness tracking platform.",
};
        ...
        <div className="space-y-10 text-sm leading-relaxed text-foreground/90">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              By creating an account or using Zor (&ldquo;the Service&rdquo;), you agree to be
              bound by these Terms of Service. If you do not agree, do not use the Service. These terms
              form a binding agreement between you and Zor.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold mb-3">2. Acceptable Use</h2>
            <p className="text-muted-foreground mb-3">You agree to use Zor only for lawful purposes. You must not:</p>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              <a href="mailto:support@zor.app" className="text-primary hover:underline">
                support@zor.app
              </a>{" "}
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              Zor. By using the Service, you grant us a limited, non-exclusive licence to store,
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              If you use Zor as a coach, you are responsible for ensuring that any training
              programmes you create are appropriate for your clients&rsquo; fitness levels and health
              conditions. Zor does not verify coaching qualifications. You agree to comply with
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Zor is a fitness tracking tool and is not a medical device or healthcare provider.
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              To the fullest extent permitted by law, Zor shall not be liable for any indirect,
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              <a href="mailto:legal@zor.app" className="text-primary hover:underline">
                legal@zor.app
              </a>.
            </p>
          </section>
