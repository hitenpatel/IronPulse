...
export const metadata = {
  title: "Privacy Policy — Zor",
  description: "How Zor collects, uses, and protects your personal data.",
};
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="space-y-10 text-sm leading-relaxed text-foreground/90">
          ...
          <section>
            ...
            <p>
              Zor (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) is committed to protecting
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>To provide, maintain, and improve the Zor service.</li>
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              ...
              <a href="mailto:privacy@zor.app" className="text-primary hover:underline">
                privacy@zor.app
              </a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              email or by a prominent notice in the app. Continued use of Zor after the effective
