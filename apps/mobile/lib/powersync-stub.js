// Stub module for E2E builds — replaces @powersync/* and @zor/sync
...
module.exports = {
  ...
  // @powersync/common exports (used by @zor/sync schema/connector)
  ...
  // @zor/sync schema/connector exports
  AppSchema: { types: {} },
