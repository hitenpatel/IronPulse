      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 12 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
              ...
              <span className="chip blue" style={{ padding: "2px 5px", fontSize: 8.5 }}>Strength</span>
            </div>
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: 9, color: "var(--text-4)", textTransform: "uppercase", letterSpacing: ".12em" }}>Progress</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginTop: 14, paddingTop: 12, borderTop: "1px solid var(--line-soft)" }}>
          {[
            ...
            <div key={m.l}>
              <div style={{ fontSize: 9, color: "var(--text-4)", textTransform: "uppercase", letterSpacing: ".1em" }}>{m.l}</div>
...
const ProgressPhotos = () => {
  ...
  const Silhouette = ({ glow = false, month }) => (
    <div style={{
      ...
      <div style={{ position: "absolute", left: 6, top: 6, padding: "2px 5px", background: "rgba(0,0,0,.5)", borderRadius: 3, fontSize: 8.5, fontFamily: "var(--ff-mono)", color: "var(--text-2)", letterSpacing: ".08em" }}>{month}</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 6, marginBottom: 14 }}>
          {[
            ...
            <div key={s.l} style={{ padding: 10, background: "var(--bg-1)", border: "1px solid var(--line-soft)", borderRadius: 10 }}>
              <div style={{ fontSize: 9, color: "var(--text-4)", textTransform: "uppercase", letterSpacing: ".12em" }}>{s.l}</div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 4, paddingTop: 10, borderTop: "1px solid var(--blue-soft)" }}>
            {[
              ...
              <div key={s.l} style={{ textAlign: "center" }}>
                <div style={{ fontSize: 9, color: "var(--text-4)", textTransform: "uppercase", letterSpacing: ".1em" }}>{s.l}</div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 3 }}>
                <span className="chip blue" style={{ padding: "1px 5px", fontSize: 9 }}>Active</span>
                <span style={{ fontSize: 9, color: "var(--text-4)", textTransform: "uppercase", letterSpacing: ".1em" }}>6 day split</span>
              </div>
              <div className="display" style={{ fontSize: 16, fontWeight: 600 }}>PPL · Hypertrophy</div>
              <div style={{ fontSize: 10.5, color: "var(--text-3)", marginTop: 2 }}>Week 3 of 8 · deload wk 4</div>
            </div>
            <div style={{ textAlign: "right" }}>
              <div className="bignum" style={{ fontSize: 18, color: "var(--blue-2)" }}>38%</div>
              <div style={{ fontSize: 9, color: "var(--text-4)" }}>Complete</div>
            </div>
          </div>
          {/* weekly progress */}
          ...
          {days.map((day, i) => (
            <div key={i} style={{
              ...
              <div style={{ width: 32, textAlign: "center" }}>
                <div style={{ fontSize: 8.5, color: day.today ? "var(--blue-2)" : "var(--text-4)", textTransform: "uppercase", letterSpacing: ".12em", fontWeight: 600 }}>{day.d}</div>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 12.5, fontWeight: 500, color: day.c ? "var(--text)" : "var(--text-3)", display: "flex", alignItems: "center", gap: 6 }}>
                  {day.w}
                  {day.today && <span style={{ fontSize: 9, color: "var(--blue-2)", fontFamily: "var(--ff-mono)", textTransform: "uppercase", letterSpacing: ".12em", fontWeight: 700 }}>Today</span>}
                </div>
                {day.c && (
