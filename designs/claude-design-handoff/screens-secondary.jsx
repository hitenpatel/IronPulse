      ...
      <div style={{ display: "flex", gap: 5, marginBottom: 10, overflowX: "auto", paddingBottom: 2 }}>
        {[
          ...
          <span key={i} style={{
            ...
            {c.t} <span style={{ opacity: 0.6, fontFamily: "var(--ff-mono)", fontSize: 9 }}>{c.n}</span>
          </span>
        ))}
      </div>
          ...
          <div key={i} className="row">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                {e.pr && <span className="chip blue" style={{ padding: "1px 5px", fontSize: 9 }}>PR</span>}
              </div>
              <div style={{ fontSize: 10.5, color: "var(--text-3)" }}>{e.c}</div>
            </div>
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", gap: 4, marginTop: 6 }}>
              <span className="chip blue" style={{ padding: "2px 6px", fontSize: 9 }}>Level 12</span>
              <span className="chip amber" style={{ padding: "2px 6px", fontSize: 9 }}>42d streak</span>
            </div>
          </div>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 0, marginTop: 16, borderTop: "1px solid var(--line-soft)", paddingTop: 12 }}>
          {[
            ...
            <div key={i} style={{ textAlign: "center", borderLeft: i > 0 ? "1px solid var(--line-soft)" : "none" }}>
              ...
              <div style={{ fontSize: 9, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: ".12em", marginTop: 2 }}>{s.l}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="card" style={{ marginBottom: 10, textAlign: "center", padding: "16px 14px 14px" }}>
        ...
        <div style={{ position: "relative", width: 140, height: 140, margin: "0 auto" }}>
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
            <div style={{ fontSize: 9, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: ".14em", fontWeight: 600 }}>Remaining</div>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 5, marginTop: 4 }}>
          ...
          <div style={{ marginLeft: "auto", textAlign: "right" }}>
            ...
            <div style={{ fontSize: 9, color: "var(--text-4)", fontFamily: "var(--ff-mono)", textTransform: "uppercase", letterSpacing: ".12em" }}>score</div>
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 4, marginTop: 10 }}>
          {[
            ...
            <div key={s.l}>
              <div style={{ fontSize: 9, color: "var(--text-4)", display: "flex", alignItems: "center", gap: 3, textTransform: "uppercase", letterSpacing: ".08em" }}>
