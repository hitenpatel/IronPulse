    ...
    <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "40px 20px 28px", position: "relative" }}>
      ...
      <div style={{ marginTop: 40, marginBottom: 36, textAlign: "center" }}>
        <div style={{
          ...
          position: "relative",
          filter: "drop-shadow(0 18px 32px rgba(58,109,255,.45))",
        }}>
          <Icons.Logo size={84} />
          <div style={{ position: "absolute", inset: -8, borderRadius: 28, border: "1px solid rgba(58,109,255,.35)", pointerEvents: "none" }}/>
          <div style={{ position: "absolute", inset: -16, borderRadius: 32, border: "1px solid rgba(58,109,255,.18)", pointerEvents: "none" }}/>
        </div>
        <div className="display" style={{ fontSize: 38, fontWeight: 700, letterSpacing: "-0.035em", lineHeight: 1 }}>
          Iron<span style={{ color: "var(--blue)" }}>Pulse</span>
        </div>
        <div style={{ color: "var(--text-3)", fontSize: 13, marginTop: 8, fontWeight: 500 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 14 }}>
        <div>
          <div style={{ fontSize: 10, color: "var(--text-3)", fontWeight: 600, marginBottom: 6 }}>Email</div>
          <input className="input" placeholder="you@example.com" />
        </div>
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
            <div style={{ fontSize: 10, color: "var(--text-3)", fontWeight: 600 }}>Password</div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "4px 0 14px", color: "var(--text-4)", fontSize: 10.5, letterSpacing: ".1em" }}>
  ...
  <>
    <div className="body scroll">
      ...
      <div style={{ marginBottom: 16 }}>
        <div style={{ fontSize: 10, color: "var(--blue-2)", fontWeight: 600, marginBottom: 4 }}>Sun · 19 Apr · Week 3</div>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 10 }}>
          ...
          <span style={{ fontSize: 10, color: "var(--blue-2)", fontWeight: 600 }}>Next up · 62 min</span>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 6, marginBottom: 16 }}>
        {[
          ...
          <div key={s.l} style={{ padding: 10, background: "var(--bg-1)", border: "1px solid var(--line-soft)", borderRadius: 10 }}>
            <div style={{ fontSize: 9.5, color: "var(--text-3)", fontWeight: 600 }}>{s.l}</div>
          ...
          <div key={i} className="row">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 12.5, fontWeight: 500, display: "flex", alignItems: "center", gap: 6 }}>
                {a.t} {a.pr && <span className="chip blue" style={{ padding: "2px 6px", fontSize: 10 }}>PR</span>}
              </div>
    ...
    <div className="body scroll" style={{ paddingBottom: 0 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "4px 0 10px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div>
            <div style={{ fontSize: 9.5, color: "var(--blue-2)", fontWeight: 600 }}>Push A · wk 3</div>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 9.5, color: "var(--blue-2)", fontWeight: 600 }}>Rest</div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "var(--blue)",
          color: "#fff",
          fontSize: 8.5, fontWeight: 700, fontFamily: "var(--ff-mono)",
          borderRadius: "0 0 5px 5px",
          color: "var(--blue-ink)",
          boxShadow: "0 2px 8px -2px var(--blue-glow)" }}>A1 · ACTIVE</div>
        ...
        {[
          ...
          <div key={i} style={{
            ...
            {s.active ? (
              <button style={{ background: "var(--blue)", color: "var(--blue-ink)", fontSize: 9.5, fontWeight: 700, border: 0, borderRadius: 5, padding: "4px 6px", letterSpacing: ".1em" }}>LOG</button>
            ) : s.done ? (
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 4, padding: "1px 6px", background: "var(--purple-soft)", color: "var(--purple)", borderRadius: 4, fontSize: 8.5, fontWeight: 700 }}><Icons.Link /> Superset</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: 10, alignItems: "stretch" }}>
          <div>
            <div className="mono" style={{ fontSize: 9, color: "var(--purple)", fontWeight: 700 }}>B1</div>
          ...
          <div>
            <div className="mono" style={{ fontSize: 9, color: "var(--purple)", fontWeight: 700 }}>B2</div>
        ...
        <div style={{ display: "flex", gap: 3, padding: 2, background: "var(--bg-1)", border: "1px solid var(--line)", borderRadius: 6 }}>
          {["4w", "12w", "1y"].map((r, i) => (
            <span key={r} style={{
              ...
              borderRadius: 4, fontFamily: "var(--ff-mono)", fontWeight: 500 }}>{r}</span>
          ))}
        </div>
      </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
          {[
            ...
            <div key={m.l} style={{ textAlign: "left" }}>
              <div style={{ fontSize: 9, color: "var(--text-4)", fontFamily: "var(--ff-mono)" }}>{m.s}</div>
