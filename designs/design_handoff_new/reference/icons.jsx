...
const Icons = {
  Logo: ({ size = 18, flat = false }) => (
    // IRONPULSE v3 — cobalt tile, white dumbbell, lime pulse waveform.
    <svg width={size} height={size} viewBox="0 0 40 40" fill="none" aria-hidden="true">
      ...
      {!flat && <rect x="1" y="1" width="38" height="20" rx="11" fill="url(#ip-glow)"/>}
      <rect x="1.5" y="1.5" width="37" height="37" rx="10.5"
        stroke="rgba(255,255,255,0.20)" strokeWidth="1" fill="none"/>

      {/* DUMBBELL — bar + plates in warm white */}
      <g stroke="#F4F0E6" strokeLinecap="round" strokeLinejoin="round" fill="none">
  ...
  // Wordmark — lockup used on Login & gallery hero
  Wordmark: ({ size = 28, color = "currentColor" }) => (
    <svg height={size} viewBox="0 0 280 44" fill="none" aria-hidden="true">
      <text x="0" y="34"
        fontFamily="'Space Grotesk', system-ui, sans-serif"
        fontWeight="700"
        fontSize="38"
        letterSpacing="-1.4"
        fill={color}>Iron<tspan fill="#D4FF3A">Pulse</tspan></text>
    </svg>
  ),
